...
IMAGE_DIR = r"E:\anaconda1\deep-learning\llm\vlm\Flickr8k_Dataset\Flicker8k_Dataset"
TOKEN_FILE = r"E:\anaconda1\deep-learning\llm\vlm\Flickr8k_text\Flickr8k.token.txt"
...
class TinyMiniMindCLIPContrastiveVLM(nn.Module):
    ...
    def forward(self, vision_inputs, input_ids, attention_mask, labels=None):
        ...
        text_emb = self.text_model.transformer.wte(input_ids)  # [B, seq_len, text_dim]
...
if __name__ == "__main__":
    ...
    for epoch in range(EPOCHS):
        ...
        for vis_inputs, txt_inputs in loop:
            optimizer.zero_grad()
        ...
        torch.save(save_dict, f"mini_clip_unfreeze_epoch{epoch}.pt")
        print(f"Saved: mini_clip_unfreeze_epoch{epoch}.pt")
